...
| P2-learn11 | **learn 源卡删除后候选孤儿回链（2026-09-07 learn V2 审：backend P2⑦ 低危提示）**：learn 卡将来加删除端点时需级联候选或标注孤儿 | `LearnCandidateAppService` | 删除卡时级联处理 |
