...
资金股份查询导入后返回券商口径账户：`{"assets":110504.88,"cash":292.88,"available":292.88,"withdrawable":292.88,"marketValue":110212.00,"pnl":15235.55,"todayPnl":-1570.0,"snapshotDate":"2026-08-16"}`——顶层展示总资产/可用/可取/参考市值/当日盈亏/盈亏。数据依赖导入（每日定时任务收市后更新为后续）。需 trading 插件（403）。
