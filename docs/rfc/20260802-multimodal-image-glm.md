...
> 全部已定（2026-08-17 勾销，W-P3-25）：功能已 implemented（多模态图片记录前后端完成，见 change-log 2026-08-14 批）。

1. ✅ 方向 OK → v0.3.0、记录为主、后端先行（已按此实施）
2. ✅ Phase 2 前端先做 adai-app（拍照/相册移动端入口）——已实施，后续 adai-web 同步
