...
description: AdaiOS 的周期性人肉工作总清单——哪些系统已自动（只需看）、哪些必须你亲自做（盘后导入/备份/审查）、哪些是到期红线；配套 check_deadlines.py 与两个 LaunchAgent
version: 1
created: 2026-09-14
updated: 2026-09-14
status: active
...
**核心是三份通达信导出，顺序不能换**（持仓/资金是锚点，先建锚定再补流水）：
...
| 日期 | 事项 | 状态（2026-09-14） |
|:--|:--|:--|
| 2026-09-30 | 公安联网备案（ICP 后 30 天内） | ⚠️ **剩 16 天，未办**（REVIEW P1-合规1） |
