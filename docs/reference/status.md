...
| 端 | 测试数 | 失败 | 备注 |
|:---|:------:|:----:|:-----|
| 后端 adai-core | **429** | 0 | 15 Controller 接口测试全覆盖 + 多模态 18 + 鉴权 4 + 行情推送 15 + AI 日志 20 + 插件门控/隔离（S-3/S-4/P2-2/P2-3/P2-4 批 Q +7）|
| 前端 adai-app | **92** | 0 | Feed 状态机 12 + 6 页面 + 选号/切换链路 + 插件门控 |
| 前端 adai-web | **46** | 0 | 桌面壳 + 分页终止 + 记忆保位 + 插件门控 |
| 前端 adai-admin | **32** | 0 | 账号/数据/系统/知识页 + 插件开关 |
